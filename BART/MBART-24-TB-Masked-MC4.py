...
f = open("../../Checkpoints/LOGIT-KD-TB-MBart-%d-%d-MC4.txt" % (student_layer,student_dim), "w+", buffering= 50)
f1 = open("../../Checkpoints/LOGIT-KD-Eval-TB-MBart-%d-%d-MC4.txt" % (student_layer,student_dim), "w+", buffering= 1)
...
for batch in train_dataloader:
    with torch.cuda.amp.autocast():
        ...
        if(nBatch%vaild_sample_interval==0):
            torch.save(student.state_dict(),"../../Checkpoints/MBart-TB-%d-%d-MC4.pt" % (student_layer,student_dim))
