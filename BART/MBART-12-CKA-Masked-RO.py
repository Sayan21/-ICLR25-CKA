...
def encode(examples):
    ...
    temp = tokenizer(text_target = examples['translation'][src_lang], truncation=True, padding='max_length', max_length = 128)
...
teacher_id = "RaphaelReinauer/mbart50-finetuned-multi30-en-to-de"
tokenizer = MBart50TokenizerFast.from_pretrained(teacher_id, src_lang='en_XX', tgt_lang="ro_RO")
...
student.load_state_dict(torch.load("../../Checkpoints/BART/MBart-%d-%d-MC4.pt" % (student_layer,student_dim)))
...
# tokenized_datasets.save_to_disk('/scratch/punim0478/sayantand/Dump/EN_DE')
