...
f = open("../../Checkpoints/LOGIT-KD-nH-MBart-%d-%d-MC4.txt" % (student_layer,student_dim), "w+", buffering= 50)
f1 = open("../../Checkpoints/LOGIT-KD-Eval-nH-MBart-%d-%d-MC4.txt" % (student_layer,student_dim), "w+", buffering= 1)
from transformers import get_scheduler
vaild_sample_interval = 5000
num_training_steps = 60 * vaild_sample_interval
...
for batch in train_dataloader:
    with torch.cuda.amp.autocast():
        ...
        if(nBatch%vaild_sample_interval==0):
            torch.save(student.state_dict(),"../../Checkpoints/MBart-nH-%d-%d-MC4.pt" % (student_layer,student_dim))
