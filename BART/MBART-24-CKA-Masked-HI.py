...
teacher_id = "facebook/mbart-large-50"

tokenizer = MBart50TokenizerFast.from_pretrained(teacher_id, src_lang='en_XX', tgt_lang="hi_IN")
...
teacher.load_state_dict(torch.load("/data/projects/punim0478/sayantand/Checkpoints/BART/MBart-hi-2.pt"))
...
tokenized_datasets = load_from_disk('/scratch/punim0478/sayantand/Dump/EN_HI')
batch_size = 32
train_dataloader = DataLoader(tokenized_datasets['train'], shuffle=True, batch_size=batch_size)
test_dataset = tokenized_datasets['test']
vaild_sample_interval = len(train_dataloader)//5
...
for i in range(4):
    ...
    student.load_state_dict(torch.load("/data/projects/punim0478/sayantand/Checkpoints/BART/MBart-%d-%d-MC4.pt" % (student_layer,student_dim)))
