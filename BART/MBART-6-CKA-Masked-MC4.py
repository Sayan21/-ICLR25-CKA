...
def Create_Student(student_id,student_dim,student_layer,teacher):
    ...
    student.lm_head.weight.copy_(teacher.lm_head.weight[:,:student_dim].clone())
...
teacher_id = "facebook/mbart-large-50-one-to-many-mmt"
...
for batch in train_dataloader:
    with torch.cuda.amp.autocast():
        ...
        if(nBatch%vaild_sample_interval==0):
            torch.save(student.state_dict(),"../../Checkpoints/MBart-%d-%d-MC4.pt" % (student_layer,student_dim))
