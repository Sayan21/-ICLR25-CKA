    ...
    for batch in eval_dataloader:
        ...
        with torch.cuda.amp.autocast():
            ...
            for i in range(n_layers):
                loss[i+2] += CSLoss(masked_select(student_out.hidden_states[i],student_mask).view(-1,dS), \
                               masked_select(teacher_out.hidden_states[i],teacher_mask).view(-1,dT))
...
f = open("../Checkpoints/LOGIT-KD-12-516-All.txt", "w+", buffering= 50)
f1 = open("../Checkpoints/LOGIT-KD-Eval-12-516-All.txt", "w+", buffering= 1)
    ...
    for batch in train_dataloader:
        ...
        with torch.cuda.amp.autocast():
            ...
            if(nBatch%10000==0):
                ...
                f1.flush()
                torch.save(student.state_dict(),"../Checkpoints/Bert-12-516-Wiki.pt")
