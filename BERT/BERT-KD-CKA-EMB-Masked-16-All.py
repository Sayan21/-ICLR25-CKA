...
f = open("../../Checkpoints/BERT/LOGIT-KD-CKA-EMB-16-%d-C4.txt" % student_dim, "w+", buffering= 50)
f1 = open("../../Checkpoints/BERT/LOGIT-KD-Eval-CKA-EMB-16-%d-C4.txt" % student_dim, "w+", buffering= 1)
    ...
    for batch in train_dataloader:
        ...
        with torch.cuda.amp.autocast():
            ...
            if(nBatch%num_batch_per_epoch==0):
                ...
                f1.flush()
                torch.save(student.state_dict(),"../../Checkpoints/BERT/Bert-16-%d-CKA-C4.pt" % student_dim)
