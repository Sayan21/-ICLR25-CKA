...
f = open("../../Checkpoints/LOGIT-KD-NH-EMB-6-%d-C4.txt" % student_dim, "w+", buffering= 50)
f1 = open("../../Checkpoints/LOGIT-KD-Eval-NH-EMB-6-%d-C4.txt" % student_dim, "w+", buffering= 1)
    ...
    for batch in train_dataloader:
        ...
        with torch.cuda.amp.autocast():
            ...
            if(nBatch%num_batch_per_epoch==0):
                ...
                f1.flush()
                torch.save(student.state_dict(),"../../Checkpoints/Bert-6-%d-NH-C4.pt" % student_dim)
